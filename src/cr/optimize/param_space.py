...
import cr.optimize.model_hp as model_hp
import cr.optimize.smote_hp as smote_hp
...
final_model_param_space = dict(
    classifier=hp.choice("classifiers", selected_model_param_space)
)
